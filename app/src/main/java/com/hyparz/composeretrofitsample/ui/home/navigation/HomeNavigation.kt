...
package com.hyparz.composeretrofitsample.ui.home.navigation
...
import com.hyparz.composeretrofitsample.ui.home.HomeRoute
...
fun NavGraphBuilder.homeScreen(
    ...
    navigation(
        ...
        composable(route = homeRoute) {
            HomeRoute(navigateToUserDetails=navigateToUserDetails)
        }
        nestedGraphs()
    }
}
